...
.. note::
    ...
    The diagram shows that the Bot API acts as an intermediate layer between your bot and Telegram servers, while MTProto clients like Pyrogram connect directly.
